...
import com.exa.base.http.handlingApiExceptions
import com.exa.base.http.handlingExceptions
...
open class BaseRepository {
     ...
     */
    suspend fun <T : Any> executeResp(stateLiveData: StateLiveData<T>, block: suspend () -> BaseBean<T>) {
        var baseResp: BaseBean<T> = BaseBean()
     ...
     */
    private fun <T : Any> handleHttpOkResponse(baseResp: BaseBean<T>): BaseBean<T> {
